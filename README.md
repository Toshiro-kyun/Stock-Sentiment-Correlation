...
__A tool of analysis to determine whether Stock Sentiment is correlated to Stock Price.__ This project uses the NewsAPI to rate Stock sentiment using vaderSentiment and then calculates various correlation scores in relation to the Stock Price. Shoutout to: https://github.com/mar-antaya/nvda-sentiment
